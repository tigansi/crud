    ...
    <div class="col l10 s12 m12">
        <div class="card hoverable">
            ...
            <div class="card-content">
                ...
                <button data-target="modal-livros-excluidos" class="blue modal-trigger btn waves-effect waves-light right">Outros registros
...
<!-- Modal Cadastro de livro -->
<?php include('modal-livros-excluidos.php'); ?>
